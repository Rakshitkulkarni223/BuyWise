...
const GENERAL_SECTIONS: DocSection[] = [
    ...
    content: (
      <div className="space-y-4 text-sm text-ink-soft leading-relaxed">
        ...
        <div className="flex flex-wrap items-center justify-center gap-2 rounded-md border border-line bg-bg p-4 text-xs font-medium">
          {['🏢 Business Need', '🤖 BuyWise', '📊 Recommendation', '🧠 AI Chat', '💰 Business Impact'].map((s, i, arr) => (
        ...
        <div className="space-y-3">
          {[
            { step: 1, title: 'Search', desc: 'Type a product name, pick a category and strategy — BuyWise queries all configured suppliers simultaneously.' },
  ...
  /* ── 6. AI CHAT ASSISTANT ── */
  {
    ...
    content: (
      <div className="space-y-4 text-sm text-ink-soft leading-relaxed">
        <p>
          The <strong className="text-ink">BuyWise Advisor</strong> is a conversational AI assistant available on every page.
        ...
        <div className="rounded-md border border-line bg-bg p-4">
          ...
          <ol className="space-y-2 text-xs text-muted list-decimal list-inside">
            <li>Click the <strong className="text-ink">Ask BuyWise</strong> button (bottom-right corner of any page).</li>
  ...
  /* ── 18. INNOVATION HIGHLIGHTS ── */
  {
    ...
    content: (
      <div className="space-y-4 text-sm text-ink-soft leading-relaxed">
        <p>What makes BuyWise stand out from traditional procurement tools.</p>
        <div className="grid gap-2 sm:grid-cols-2">
          {[
  ...
  /* ── 19. COMPETITIVE ADVANTAGE ── */
  {
    ...
    content: (
      <div className="space-y-4 text-sm text-ink-soft leading-relaxed">
        <p>How BuyWise compares to traditional marketplace procurement.</p>
        <div className="overflow-x-auto rounded-md border border-line">
          <table className="w-full text-xs">
            <thead><tr className="border-b border-line bg-bg text-left"><th className="px-3 py-2 font-semibold text-ink">Feature</th><th className="px-3 py-2 font-semibold text-accent">BuyWise</th><th className="px-3 py-2 font-semibold text-muted">Traditional Marketplace</th></tr></thead>
            <tbody className="divide-y divide-line">
              {[
  ...
  /* ── 20. PERFORMANCE ── */
  {
    ...
    content: (
      <div className="space-y-4 text-sm text-ink-soft leading-relaxed">
        <p>BuyWise is built for speed and scalability.</p>
  ...
  /* ── 21. FUTURE ROADMAP ── */
  {
    ...
    content: (
      <div className="space-y-4 text-sm text-ink-soft leading-relaxed">
        <p>BuyWise's product roadmap — from current capabilities to enterprise-grade autonomous procurement.</p>
  ...
  {
    id: 'g-why-BuyWise',
    title: 'Why BuyWise Wins',
    icon: Trophy,
    badge: { label: 'Summary', tone: 'accent' },
    content: (
      <div className="space-y-4 text-sm text-ink-soft leading-relaxed">
        <p>The definitive reasons to choose BuyWise for your procurement operations.</p>
        <div className="grid gap-2 sm:grid-cols-3">
          {[
    ...
    content: (
      <div className="space-y-4 text-sm text-ink-soft leading-relaxed">
        {[
          ...
          { q: 'What AI model does the chat assistant use?', a: 'It uses Groq-hosted models — Llama 3.3-70b-versatile as the primary model with Llama 3.1-8B as fallback. Both support function calling for real-time data access.' },
...
const DEV_SECTIONS: DocSection[] = [
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="rounded-md border border-line bg-bg p-4">
            ...
            <ul className="space-y-1 text-xs text-muted">
              ...
              <li>• Groq AI Assistant (Llama 3.3-70b-versatile / Llama 3.1-8B)</li>
  ...
  /* ── AI WORKFLOW PIPELINE ── */
  {
    ...
    content: (
      <div className="space-y-4 text-sm text-ink-soft leading-relaxed">
        <p>
          When a user asks the <strong className="text-ink">BuyWise Advisor</strong> a question, it follows a deterministic multi-stage pipeline — not a random guess.
        </p>
        <div className="space-y-2">
          {[
      ...
      <div className="space-y-4 text-sm text-ink-soft leading-relaxed">
        <div className="grid gap-3 sm:grid-cols-3">
          {[
            ...
            { category: 'Backend', items: ['Python 3.13', 'FastAPI', 'Uvicorn', 'Motor (async MongoDB)', 'Pydantic', 'PyJWT / bcrypt', 'Groq AI (Llama 3.3-70b-versatile)', 'OpenAI-compatible function calling'] },
