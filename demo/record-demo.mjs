/**
 * BuyWise — Demo Video Recorder (~4 min)
 *
...
/** Scroll to an element containing the given visible text; fall back to pixel scroll */
async function scrollToText(page, text, fallbackTop = 800) {
  try {
...
/* ══════════════════════════════════════════════════════════════════
   ...
   ══════════════════════════════════════════════════════════════════ */
(async () => {
  console.log(`🎬 Recording BuyWise demo from ${BASE} …`);
  ...
  try {
    ...
    await caption(page, '🔐 Logging in to BuyWise', 2500);
    ...
    await scrollToText(page, 'Dashboard', 350);
    await wait(1500);
    await scroll(page, 0);
    ...
    await scrollToText(page, 'Business Impact', 500);

    // ROI Calculator
    await scrollToText(page, 'ROI Calculator', 1000);
    ...
    try {
      ...
      await scrollToText(page, 'Procurement Intelligence Summary', 600);
      ...
      await scrollToText(page, 'AI Advisor Insights', 1000);
      ...
      await scrollToText(page, 'Supplier Intelligence', 1400);
      ...
      await scrollToText(page, 'Supplier Mix', 1800);
    ...
    try {
      ...
      await scrollToText(page, 'Procurement Insights', 500);
      ...
      await scrollToText(page, 'Long-Term Procurement Recommendation', 1200);
      ...
      await scrollToText(page, 'Supplier Comparison Matrix', 1300);
      ...
      await scrollToText(page, 'Full Comparison Table', 1700);
    ...
    try {
      // Click floating "Ask BuyWise" button
      const aiTrigger = page.locator('button:has-text("Ask BuyWise")');
    ...
    await scrollToText(page, 'Analytics', 400);
    await wait(1500);
    await scroll(page, 0);
    ...
    await scrollToText(page, 'Built-in Documentation', 300);
    await wait(2000);

    // ─────────────────────── 3:55  OUTRO ────────────────────────────────
    console.log('▸ Outro');
    await nav(page, 'nav-dashboard');
    await caption(page, '✨ BuyWise — Intelligent Procurement. Smarter decisions. Real savings.', 5000);
    await wait(3500);
