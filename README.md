...
- ✅ Natural-language explanations generated using Groq (Llama 3.3-70b-versatile)
...
|---|---|
| Multi-factor weighted scoring | Groq (Llama 3.3-70b-versatile) |
...
The Procurement AI Assistant is a conversational interface powered by **Groq** (Llama 3.3-70b-versatile / Llama 3.1-8B) with backend function calling. It accesses live procurement data through 8 tools:
...
[Demo Video](https://github.com/user-attachments/assets/67f26c78-cfef-4fad-b2f0-cb6d5fd10612)
...
| **AI Assistant** | Groq (Llama 3.3-70b-versatile) with automatic fallback to Llama 3.1-8B |
...
- Groq LLM integration (Llama 3.3-70b-versatile) with automatic fallback to Llama 3.1-8B, then rule-based explanations
...
AI_PRIMARY_MODEL=lama-3.3-70b-versatile          # Optional — default: lama-3.3-70b-versatile
